...
<section>
  <div class="log_img">
   <br>
    <div class="box1">
        <h1 style="text-align: center; font-size: 35px;font-family: Lucida Console;">JH E-LIBRARY</h1>
    ...
    if(isset($_POST['submit']))
    {
      ...
      if($count==0)
      {
        ?>
              ...
              -->
          <div class="alert alert-danger" style="width: 600px; margin-left: 370px; margin-top: -60px; background-color: #de1313; color: white">
